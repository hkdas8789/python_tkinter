...
root = Tk()
root.geometry("487x254")
root.minsize(487,254)
root.maxsize(487,254)
...
Button(F1,text="file data",font="mango 10 bold",bg="Blue",fg="Cyan",command=files).grid(row=6,column=4)  #############################
Button(F1, text='Submit', fg='Cyan', bg='Blue', font='mango 10 bold', command=printdet).grid(row=6, column=3)
# Q=quit
#Button(F1, text='Quit', fg='Cyan', bg='Blue', font='mango 10 bold', command=Q).grid(row=6, column=4)
